...
\begin{lemma}[call-by-need reduction respects path substitution]
...
\begin{proof}
An easy induction, using the fact that call-by-need reduction respects path substitution.
\end{proof}
...
\begin{proof}
An easy induction, using the fact that call-by-need reduction is confluent.
\end{proof}
...
\begin{proof}
%Extract as lemma
By reduction and expansion, we may assume that $P$ and $Q$ are normal forms.  We also have that $\varphi'$ reduces to a canonical proposition
