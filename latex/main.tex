...
\therefore & \vdash (\reff{H})_{FI}(\triplelambda e:x =_\Omega y. P) & : & \top \rightarrow \top =_\Omega \top \\
\therefore & \vdash ((\reff{H})_{FI}(\triplelambda e:x =_\Omega y.P))^- & : & \top \rightarrow \top \rightarrow \top
\end{align*}
