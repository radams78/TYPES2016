...
We present a deterministic call-by-need reduction relation for this system, and prove that every typable term reduces to a canonical form.  From this, it follows that the system is consistent.  
...
Define the relation of \emph{call-by-need reduction} $\rightarrow$ on the expressions.  The inductive
